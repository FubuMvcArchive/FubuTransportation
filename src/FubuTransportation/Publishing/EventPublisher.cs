...
{
    public class EventPublisher<T> : BasicBehavior, IMayHaveResourceType where T : class
    {
        private readonly IFubuRequest _request;
        private readonly IServiceBus _serviceBus;
        private readonly ILogger _logger;

        public EventPublisher(IFubuRequest request, IServiceBus serviceBus, ILogger logger)
